...
@interface SmsChatViewController ()
...
- (void)addMessage {
    ...
    NSArray *contactArray = @[@{@"id":fid, @"telphone":self.tel}];

    
//    NSString *myUid = [PersistenceHelper dataForKey:kUserId];
//    NSDictionary *dict = [NSDictionary dictionaryWithObjectsAndKeys:@"sendSMSforPeople.json", @"path", myUid, @"userid", fid, @"destuserid", content, @"content",nil];
...
//    NSString *tel = myInfo.userDetail.tel;
    ...
    NSDictionary *dict = [NSDictionary dictionaryWithObjectsAndKeys:jsonDataStr, @"jsondata", userid, @"userid", @"sendSMSforPeople.json", @"path", nil];
...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([cell isKindOfClass:[OtherTalkCell class]]) {
        ...
        [[(TimeSplitCell *)cell labTime] setText:[dict objForKey:@"content"]];
    } else{
