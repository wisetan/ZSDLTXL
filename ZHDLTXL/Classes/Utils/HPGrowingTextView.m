...
-(void)commonInitialiser
{
    ...
    if (self.placeHolder) {
        ...
        internalTextView.textColor = placeHolderColor;
    } else {
        internalTextView.text = @"";
        internalTextView.textColor = contentColor;
    }
...
- (BOOL)textViewShouldBeginEditing:(UITextView *)textView {
    ...
    if (self.placeHolder && [internalTextView.text isEqualToString:self.placeHolder]) {
        internalTextView.textColor = contentColor;
        internalTextView.text = @"";
    } else {
        internalTextView.textColor = self.contentColor;
    }
...
- (BOOL)textViewShouldEndEditing:(UITextView *)textView {
    if (self.placeHolder && ![internalTextView hasText]) {
        internalTextView.textColor = placeHolderColor;
        internalTextView.text      = self.placeHolder;
    } else {
        internalTextView.textColor = contentColor;
